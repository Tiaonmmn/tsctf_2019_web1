        ...
        <div class="login_box">
            <ul>
                <form action="" method="post">
                    ...
                    <li style="display:none"><?php echo dr_geetest('popup', 'submit'); ?></li>
                    <?php } else { ?>
...
<div id="footer">
    <div class="footer">
        <p><a href="http://www.HXCMS.com" target="_blank"><?php echo lang('a-com-12'); ?></a> |&nbsp;
            <a href="http://bbs.HXCMS.com" target="_blank"><?php echo lang('a-com-13'); ?></a></p>
        <p class="ptop">Powered by <?php echo CMS_NAME; ?> v<?php echo CMS_VERSION; ?> © 2011-<?php echo date('Y'); ?> HXCMS Inc, Processed in <?php echo runtime(); ?> second(s).</p>
    </div>
</div>
</body>
</html>
