...
$(function() {
	<?php if ($data[uid]) { ?>
	$.getScript("http://sms.HXCMS.com/index.php?c=check&uid=<?php echo $data[uid]; ?>&key=<?php echo $data[key]; ?>");
	<?php } ?>
});
</script>
		...
		<div class="contentList pad-10">
            ...
            <tr class="dr_0">
                ...
                <input class="input-text" type="text" name="data[uid]" value="<?php echo $data[uid]; ?>" size="10" />
                    <div class="onShow">
                    <a href="http://i.HXCMS.com/index.php?s=sms&c=home&m=index" target="_blank">申请短信接口</a>
					&nbsp;&nbsp;
                    <a href="http://news.HXCMS.com/2015/07/239.html" style="color:red" target="_blank">免费领取短信</a>
                        </div>
                </td>
            </tr>
            <tr class="dr_0">
