...
class AdminController extends Plugin {
    ...
    public function __construct() {
		...
		$this->file_url = 'http://www.HXCMS.com/free/';
		$this->data_url = 'http://www.HXCMS.com/index.php?c=v1&m=vlist&name='.CMS_VERSION;
		if ($result = fn_check_url()) {
		    $this->adminMsg($result . '<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://bbs.HXCMS.com/forum.php?mod=viewthread&tid=100&extra=" target="_blank" style="font-size:14px">单击查看开启方式</a>');exit;
		}
    }
	...
	public function upgradeAction() {
		...
		if ($data) {
			foreach($data as $t) {
                ...
                $content .= "	'CMS'    => 'HXCMS', " . PHP_EOL;
                $content .= "	'name'    => 'HXCMS免费版', " . PHP_EOL;
