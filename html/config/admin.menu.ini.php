...
return array (
	 ...
	 */
    'top' => array (
                0 => array('name' => 'a-men-0', 'ico' => 'icon-home', 'url' => url('admin/index/main'), 'select' => '1',   'option' => ''),
				1 => array('name' => 'a-men-1', 'ico' => 'icon-cog', 'url' => url('admin/index/config'), 'select' => '101', 'option' => array('index-config', 'user-index', 'user-syn','auth-index','index-log','index-attack', 'ip-index')),
                2 => array('name' => 'a-men-90', 'ico' => 'icon-globe', 'url' => url('admin/site/config'), 'select' => '121', 'option' => array('site-config', 'site-index','category-index', 'model-index', 'attachment-index', 'position-index', 'relatedlink-index', 'block-index', 'linkage-index', 'form-index')),
                9 => array('name' => 'a-men-2', 'ico' => 'icon-table', 'url' => '', 'select' => '0', 'option' => array('content-index')),
				6 => array('name' => 'a-men-4', 'ico' => 'icon-html5', 'url' => url('admin/html/index'), 'select' => '601', 'option' => array('html-index', 'html-cache')),
				3 => array('name' => 'a-men-5', 'ico' => 'icon-user', 'url' => url('admin/member/index'), 'select' => '301', 'option' => array('member-index', 'member-config', 'member-group', 'member-pms','member-extend')),
				4 => array('name' => 'a-men-6', 'ico' => 'icon-code', 'url' => url('admin/theme/index'), 'select' => '401', 'option' => array('theme-index', 'theme-cache')),
				5 => array('name' => 'a-men-7', 'ico' => 'icon-cloud', 'url' => url('admin/plugin/index'), 'select' => '501', 'option' => array('plugin-index')),
            ),
	/**
	 * 顶部菜单对应的左侧菜单列表
	 * 格式 array(
	...
	'list' => array(
			    ...
			    1 => array(
					'a-men-11' => array(
						...
						177 => array('name' => 'dr003', 'url' => url('admin/index/bq'), 'option' => 'index-bq'),
						...
						159 => array('name' => 'dr004', 'url' => url('admin/sms/index'),    'option' => 'sms-index'),
						178 => array('name' => 'dr017', 'url' => url('admin/user/syn'),    'option' => 'user-syn'),
					),
					'a-men-20' => array(
				...
				2 => array(
					...
					'dr018' => array(
						270 => array('name' => 'dr019', 'url' => url('admin/wx/config'),    'option' => 'wx-config'),
						274 => array('name' => 'dr020', 'url' => url('admin/wx/index'),    'option' => 'wx-index'),
						271 => array('name' => 'dr021', 'url' => url('admin/wx/keyword'),    'option' => 'wx-keyword'),
						272 => array('name' => 'dr023', 'url' => url('admin/wx/menu'),    'option' => 'wx-menu'),
						273 => array('name' => 'dr024', 'url' => url('admin/wx/user'),    'option' => 'wx-user'),
					),
					'a-men-74' => array(
